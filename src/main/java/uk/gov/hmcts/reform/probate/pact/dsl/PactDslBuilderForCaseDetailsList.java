...
//                            .stringType("notApplyingExecutorDiedBefore", "Yes")))
    ...
    public static DslPart buildCaseDetailsDsl(Long caseId, String emailAddress, boolean withExecutors, boolean isWelsh,
                                              boolean withPayments) {
        return newJsonBody((o) -> {
            o.numberType("id", caseId)
                    .stringType("jurisdiction", "GrantOfRepresentation")
                    .stringType("state", "CaseCreated")
                    .stringType("case_type", "gop")
                    .object("data", (dataMap) -> {
    ...
    public static DslPart buildSearchResultDsl(Long caseId, String emailAddress,
                                               boolean withExecutors, boolean withPayments, boolean isWelsh) {
        return newJsonBody((o) -> {
