...
public final class PactDslBuilderForCaseDetailsList {
    ...
    private static void getCaseData(final String emailAddress, final boolean withExecutors, final boolean withPayments,
        ...
        dataMap.numberType("outsideUKGrantCopies", 6)
                ...
                .minArrayLike("payments", 0, 1, payment -> payment
                ...
                .object("legalStatement", (legalStatement) -> legalStatement
                    ...
                    .minArrayLike("executorsNotApplying", 4, 0, executorNotApplying -> executorNotApplying
                ...
                .minArrayLike("executorsApplying", 2, 2, executorApplying -> executorApplying
                ...
                .minArrayLike("boDocumentsUploaded", 0, 0, boDocumentsUploaded -> boDocumentsUploaded.stringType(""))
                ...
                .minArrayLike("deceasedAliasNameList", 0, 0, deceasedAliasNameList ->
                                deceasedAliasNameList.stringType(""))
                ...
                .minArrayLike("probateNotificationsGenerated", 0, 0,
                    probateNotificationsGenerated -> probateNotificationsGenerated.stringType(""))
                .stringType("deceasedMarriedAfterWillOrCodicilDate", "No");
    }
    /*   .stringType("deceasedEstateLand","Hyd eithaf ein gwybodaeth a&rsquo;n cred, nid oedd unrhyw dir wedi&rsquo;i
freinio yn Deceased fn Deceased ln a setlwyd cyn marwolaeth (ac nid drwy ewyllys) Deceased fn Deceased ln ac a oedd dal
        yn dir a setlwyd er gwaethaf y farwolaeth honno.")
                .stringType("deceasedOtherNames","")
                .stringType("deceasedEstateValue","Mae gwerth gros yr ystad yn &pound;2000000.00 ac mae gwerth net yr
                ystad yn &pound;1000000.00.")
