...
public class DateOfBirthBeforeDateOfDeathValidatorTest {
    ...
    DateOfBirthBeforeDateOfDeathValidator dateOfBirthBeforeDateOfDeathValidator = new DateOfBirthBeforeDateOfDeathValidator();
    ...
    public void shouldReturnFalseIfDodB4Dob(){
        ...
        GrantOfRepresentation grantOfRepresentation = GrantOfRepresentation.builder().deceasedDateOfBirth(afterDate).deceasedDateOfDeath(beforeDate).build();
    ...
    public void shouldReturnTrueIfDodAfterDob(){
        ...
        GrantOfRepresentation grantOfRepresentation = GrantOfRepresentation.builder().deceasedDateOfBirth(beforeDate).deceasedDateOfDeath(afterDate).build();
        boolean result = dateOfBirthBeforeDateOfDeathValidator.isValid(grantOfRepresentation, null);
