...
public class NetValueAssetsOverseasMandatoryValidatorTest {
    ...
    NetValueAssetsOverseasMandatoryValidator netValueAssetsOverseasMandatoryValidator = new NetValueAssetsOverseasMandatoryValidator();

    @Test
    public void shouldReturnFalseIfGrossIhtLessThanNetIhtValue(){

        GrantOfRepresentation grantOfRepresentation = GrantOfRepresentation.builder().assetsOverseas(Boolean.TRUE).build();
    ...
    public void shouldReturnTrueIfGrossIhtMoreThanNetIhtValue(){
        ...
        GrantOfRepresentation grantOfRepresentation = GrantOfRepresentation.builder().assetsOverseas(Boolean.TRUE).netValueAssestsOverseas(200000L).build();
        boolean result = netValueAssetsOverseasMandatoryValidator.isValid(grantOfRepresentation, null);
